...
mcmclib_at7_suff* mcmclib_at7_suff_alloc(mcmclib_raptor_gamma* g, int t0) {
...
mcmclib_amh* mcmclib_at7_alloc(gsl_rng* r,
  ...
  mcmclib_at7_suff* suff = mcmclib_at7_suff_alloc(gamma, t0, gamma);
...
void mcmclib_at7_free(mcmclib_amh* p) {
  ...
  mcmclib_at7_q_free((mcmclib_at7_q*) p->mh->q);
...
void mcmclib_raptor_set_sf(mcmclib_amh* p, const gsl_vector* sf) {
